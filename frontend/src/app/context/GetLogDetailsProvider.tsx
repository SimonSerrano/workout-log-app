...
export default function GetLogDetailsProvider(props: PropsWithChildren) {
  ...
  const useCase = new getLogDetailsUseCase(new WorkoutLogClient(), new WorkoutLogResponseMapper());

  return <GetLogDetailsContext.Provider value={useCase}>{props.children}</GetLogDetailsContext.Provider>
}
